package com.techbytes.ed.kafka.consumer.config;
...
public class KafkaConsumerConfig <K extends Serializable, V extends SpecificRecordBase>{
    ...
    public KafkaConsumerConfig(KafkaDataConfig configData, KafkaConsumerConfigData consumerConfigData) {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(kafkaConfigData.getSchemaRegistryUriKey(), kafkaConfigData.getSchemaRegistryUri());
