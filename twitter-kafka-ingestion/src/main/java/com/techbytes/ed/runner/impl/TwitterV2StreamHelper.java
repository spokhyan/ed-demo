...
@Component
@ConditionalOnProperty(name = "twitter-kafka-ingestion.enable-v2-tweets", havingValue = "true", matchIfMissing = true)
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterKafkaIngestionConfigData twitterConfigData, TwitterKafkaStatusListener twitterStatusListener) {
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterConfigData.getTwitterV2BaseUrl());
        ...
        logger.info("response from Twitter: " + response);
    ...
    void setupRules(String bearerToken, Map<String, String> rules) throws IOException, URISyntaxException {
        ...
        logger.info("existingRules.size(): " + existingRules.size());
        if (existingRules.size() > 0) {
            deleteRules(bearerToken, existingRules);
        }
        createRules(bearerToken, rules);
        logger.info("Created rules for twitter stream {}", rules);
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterConfigData.getTwitterV2RulesBaseUrl());
        ...
        logger.info("body : " + body.toString() + "httpPost " + httpPost.toString());
        ...
        if (null != entity) {
            ...
            //logger.info("entity: " + EntityUtils.toString(entity, "UTF-8"));
        }
    }
